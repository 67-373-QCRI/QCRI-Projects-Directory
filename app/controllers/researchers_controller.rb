class ResearchersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @researcher.save
        format.html { redirect_to researcher_url(@researcher), notice: "Researcher was successfully created." }
  ...
  def update
    respond_to do |format|
      if @researcher.update(researcher_params)
        format.html { redirect_to researcher_url(@researcher), notice: "Researcher was successfully updated." }
